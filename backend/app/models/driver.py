...
from sqlalchemy import Column, String, Text, Date, DateTime, Boolean, ForeignKey, CheckConstraint, Index, LargeBinary
...
class Driver(Base):
    ...
    # Profile Photo (stored as bytea in PostgreSQL)
